...
export function PublicMyTicket() {
  ...
  if (!ticket) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6">
        <Ticket className="h-16 w-16 text-zinc-600 mb-4" />
        <h2 className="text-xl font-semibold text-white mb-2 text-center">Ticket not found</h2>
        <Link
          to={eventId ? `/events/${eventId}` : '/directory'}
    ...
    <div className="min-h-screen bg-black">
      <header className="border-b border-zinc-800 bg-black sticky top-0 z-10">
        <div className="max-w-lg mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-lg font-semibold text-white">Your ticket</h1>
        </div>
      </header>
