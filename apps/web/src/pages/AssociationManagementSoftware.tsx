    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <Section className="text-center pt-16 md:pt-24" narrow>
        ...
        <p className="text-lg md:text-xl text-zinc-400 max-w-3xl mx-auto mb-4 leading-relaxed">
          MemberCore replaces scattered emails and dated portals with one modern hub for your association's members, events, and dues at a flat $97/month, unlimited members.
        </p>
